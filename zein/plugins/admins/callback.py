...
from zein import YouTube, app
from zein.core.call import VIP
from zein.misc import SUDOERS, db
...
from zein.utils.formatters import seconds_to_min
from zein.utils.inline import close_markup, stream_markup, stream_markup_timer
from zein.utils.stream.autoclear import auto_clean
from zein.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
